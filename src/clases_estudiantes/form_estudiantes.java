                ...
                try {
                    ...
                    while (resultado.next())
                    {
                        JOptionPane.showMessageDialog(null,
                                ...
                                "Cédula: " + resultado.getString("cedula") + "\n" +
                                "Correo: " + resultado.getString("correo") + "\n" +
                                "Nota 1: " + resultado.getDouble("nota_1") + "\n" +
                                "Nota 2: " + resultado.getDouble("nota_2") + "\n" +
                                "Promedio: " + resultado.getDouble("promedio") + "\n");
                    }
                    conexion.close();
                }
                catch (SQLException ex) {
                    JOptionPane.showMessageDialog(null, "Error al mostrar los registros." + ex.getMessage());
                    ex.printStackTrace();
                }
            }
        });
